...
-- AlterTable
ALTER TABLE "images" ALTER COLUMN "description_vector" SET DATA TYPE vector(3072) USING description_vector::jsonb::text::vector(3072);

-- AlterTable
ALTER TABLE "keeps" ALTER COLUMN "content_vector" SET DATA TYPE vector(3072) USING content_vector::jsonb::text::vector(3072),
ALTER COLUMN "summary_vector" SET DATA TYPE vector(3072) USING content_vector::jsonb::text::vector(3072),
ALTER COLUMN "title_vector" SET DATA TYPE vector(3072) USING content_vector::jsonb::text::vector(3072);

-- AlterTable
ALTER TABLE "moments" ALTER COLUMN "content_vector" SET DATA TYPE vector(3072) USING content_vector::jsonb::text::vector(3072);
