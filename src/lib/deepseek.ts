...
输出要求：
1. 采用技术博客风格，突出技术深度
2. 结构清晰，层次分明，确保行文有逻辑性和连贯性
3. 适当使用图表、代码块等辅助说明
4. 注重实用性，可直接应用到工作中
5. 输出格式为 Markdown，但是不需要 Markdown 标签，只是 Markdown 格式的内容
6. 直接输出内容，不要有任何前置说明，**不要输出 prompt 介绍**
7. 适当使用表格、列表等结构化形式
8. 重要概念使用加粗标记
9. 代码示例使用代码块标注
10. 技术术语使用英文原文
11. 行文风格不要拘泥于 prompt，不需要按照 prompt 本身的结构来输出
